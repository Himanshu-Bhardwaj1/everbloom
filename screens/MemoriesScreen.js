...
// const dummyMemories = Array(9).fill().map((_, index) => ({
//     id: index.toString(),
//     imageUrl: 'https://via.placeholder.com/300x300.png?text=Memory',
...
//             {!item.revealed ? (
//                 <View style={styles.overlay}>
//                     <Ionicons name="ellipse-outline" size={24} color="#fff" style={{ marginBottom: 8 }} />
//                     <Text style={styles.overlayText}>Tap to Reveal</Text>
//                 </View>
//             ) : (
//                 <View style={styles.captionContainer}>
